...
class TestMCPTools:
    ...
    def test_friction_log(self, tmp_path):
        ...
        tool_provider = HLFToolProvider(
            resource_provider=resource_provider, vm_executor=None, friction_drop=friction_drop
        )
    ...
    def test_compose(self):
        ...
        result = tool_provider.call_tool(
            "hlf_compose",
            {
                "programs": ["module a { fn f1() { ret 1 } }", "module b { fn f2() { ret 2 } }"],
                "strategy": "sequential",
            },
        )
...
class TestMCPrompts:
    ...
    def test_initialize_agent_prompt(self):
        ...
        prompt = provider.get_prompt("hlf_initialize_agent", {"tier": "forge", "profile": "P0"})
    ...
    def test_initialize_agent_with_focus(self):
        ...
        prompt = provider.get_prompt(
            "hlf_initialize_agent", {"tier": "sovereign", "profile": "P2", "focus": "code analysis"}
        )
