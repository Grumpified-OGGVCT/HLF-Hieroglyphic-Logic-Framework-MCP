...
exports.up = async function (knex) {
  ...
  await knex.raw('CREATE INDEX IF NOT EXISTS idx_messages_channel_id_created_at ON messages(channel_id, created_at)');
...
exports.down = async function (knex) {
  ...
  await knex.raw('DROP INDEX IF EXISTS idx_messages_channel_id_created_at');
