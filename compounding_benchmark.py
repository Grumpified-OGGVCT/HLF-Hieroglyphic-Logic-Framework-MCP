    ...
    if bridge is not None:
        try:
            system_prompt = (
                ...
                "intents into valid HLF source code.\n\n"
                ...
                "⌘ (delegate/route/goal), ⌂ (memory), ∇ (source)\n"
            ...
            prompt = (
                ...
                f"one GOAL ⌘ glyph for the objective, Δ glyphs for each action/step, "
                f"Ж glyphs for constraints, and Σ glyphs for expected results. "
