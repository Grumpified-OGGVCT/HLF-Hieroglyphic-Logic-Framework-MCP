...
- Preserve the explicit HLF-native knowledge-substrate line so Infinite RAG, exemplar memory, weekly knowledge ingest, and governed retrieval are tracked as one constitutive surface rather than split into unrelated feature buckets.
