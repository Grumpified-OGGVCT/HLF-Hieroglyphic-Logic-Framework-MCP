...
def MATH_MIN(a, b): return min(a, b)
def MATH_MAX(a, b): return max(a, b)
def MATH_POW(base, exp): return _math.pow(base, exp)
...
def MATH_PI(): return _math.pi
def MATH_E(): return _math.e
