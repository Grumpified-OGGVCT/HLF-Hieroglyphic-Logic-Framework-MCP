...
See [QUICKSTART.md](QUICKSTART.md) for the fastest path to a working local setup, or jump to [§2 Quick Start](#2-quick-start) below for detailed instructions including Docker deployment and MCP client configuration.
...
1. **Front door (above):** What HLF is, why it exists, and how to try it in 30 seconds.
2. **Reference (below):** The complete technical reference — vision, architecture, language spec, governance, and roadmap — preserved in full.

The original preamble and three-lane doctrine are preserved below as [§Start Here](#start-here). See [HLF_CLAIM_LANES.md](docs/HLF_CLAIM_LANES.md) for the formal claim-lane discipline.
...
See [HLF_CLAIM_LANES.md](docs/HLF_CLAIM_LANES.md) for the formal specification of claim-lane discipline, and [HLF_VISION_DOCTRINE.md](HLF_VISION_DOCTRINE.md) for the full vision statement.
