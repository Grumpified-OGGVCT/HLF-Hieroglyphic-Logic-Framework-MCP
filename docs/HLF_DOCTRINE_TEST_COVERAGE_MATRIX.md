...
| Human-readable trust surface | `hlf_mcp/hlf/insaits.py`, `hlf_mcp/server_translation.py`, `hlf_mcp/server_resources.py`, `hlf_mcp/hlf/audit_chain.py`, `hlf_mcp/governed_review.py`, `hlf_mcp/hlf/symbolic_surfaces.py` | `tests/test_insaits.py`, `tests/test_fastmcp_frontdoor.py`, `tests/test_governance_spine.py`, `tests/test_governed_review.py`, `tests/test_symbolic_surfaces.py`, `tests/test_dream_cycle.py` | Partial but stronger than public-main perception | Continuous transparency, operator dashboards, richer effect previews, and gallery-grade proof artifacts remain bridge work even though packaged operator-readable review and symbolic proof surfaces now exist |
| Routing fabric | `hlf_mcp/server_profiles.py`, `hlf_mcp/hlf/runtime.py`, `hlf_mcp/hlf/routing_trace.py`, `hlf_mcp/hlf/model_catalog.py` | `tests/test_runtime_memory_context.py`, `tests/test_fastmcp_frontdoor.py` | Partial | Upstream gateway/router semantics are still not fully restored, but packaged route traces, governed provider selection, evidence-aware denial, and profile-capability/resource proof now exist |
| Formal verification lane | `hlf_mcp/hlf/formal_verifier.py`, `hlf_mcp/hlf/execution_admission.py`, `hlf_mcp/hlf/runtime.py`, `hlf_mcp/server_capsule.py` | `tests/test_formal_verifier.py`, `tests/test_fastmcp_frontdoor.py` | Partial | Packaged verifier behavior, report shaping, and front-door/resource proof now exist; deeper upstream proof semantics and broader constraint coverage remain bridge work |
| Embodied action boundary | `governance/host_functions.json`, `hlf_mcp/hlf/embodied.py`, `hlf_mcp/server_capsule.py`, `hlf_mcp/hlf/runtime.py` | `tests/test_embodied_contracts.py`, `tests/test_fastmcp_frontdoor.py`, `tests/test_gen_from_spec.py` | Partial | Current proof covers supervisory contract metadata, approval-required guarded actuation, missing-evidence denial, tier-gated runtime dispatch, and simulation-only runtime behavior. Embodied action envelopes are not yet threaded through deeper verifier-backed spatial or motion proof, and execution-admission, route, witness, and operator-resource integration is not yet complete beyond the host-call/runtime slice. |
...
| Weekly artifact and workflow proof | `.github/scripts/*`, `hlf_mcp/weekly_artifacts.py`, `hlf_mcp/test_runner.py`, `hlf_mcp/evidence_query.py` | `tests/test_workflow_support.py`, `tests/test_weekly_artifacts.py`, `tests/test_test_runner.py`, `tests/test_github_scripts.py`, `tests/test_evidence_query.py`, `tests/test_governed_review.py` | Strong | Need tie-in to broader doctrine batch acceptance gates, but the branch now also proves operator decision persistence and normalized governed-review outputs |
